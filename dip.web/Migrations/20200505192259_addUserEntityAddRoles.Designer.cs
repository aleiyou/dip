...
namespace dip.web.Migrations
{
    ...
    [Migration("20200505192259_addUserEntityAddRoles")]
    partial class addUserEntityAddRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dip.web.Data.Entities.UserEntity", b =>
                {
            ...
            modelBuilder.Entity("dip.web.Data.Entities.UserGroupEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("dip.web.Data.Entities.DipEntity", b =>
                {
                    b.HasOne("dip.web.Data.Entities.UserEntity", "User")
                        .WithMany("Taxis")
            ...
            modelBuilder.Entity("dip.web.Data.Entities.UserEntity", b =>
                {
                    b.HasOne("dip.web.Data.Entities.UserGroupEntity")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("dip.web.Data.Entities.UserEntity")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
